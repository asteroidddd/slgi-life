  ...
  return (
    <span className="relative inline-flex group">
      ...
      <span
        id={id}
        role="tooltip"
        className={`app-tooltip app-tooltip--compact pointer-events-none absolute z-[var(--tooltip-z)] whitespace-nowrap text-left tracking-normal opacity-0 transition-all duration-[120ms] ease-out group-hover:opacity-100 group-focus-within:opacity-100 ${placementClasses[placement]}`}
      >
        {label}
      </span>
    </span>
