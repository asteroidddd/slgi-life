...
import { getAdongMatchCounts } from '@/features/common/lib/api';
import type { MatchCountsResponse, MatchFilters } from '@/features/common/types/api';
...
export function useAdongMatchCounts(
  ...
  return useQuery({
    queryKey: [
      ...
      debounced.converted_min,
      debounced.converted_max,
      debounced.area_min,
      debounced.area_max,
    ] as const,
