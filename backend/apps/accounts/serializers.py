...
def _validate_school_name(value: str | None) -> str:
...
class RegisterSerializer(serializers.Serializer):
    ...
    def validate_school(self, value: str | None) -> str:
        if self.instance is not None and (value or "").strip() == (self.instance.school or "").strip():
            return (value or "").strip()
        return _validate_school_name(value)
