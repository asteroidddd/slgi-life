...
- answer에는 추천 결과 전체를 요약하는 1~2문장만 작성하세요.
- answer에 [추천 동네] 섹션, 번호 목록, 후보별 한줄평, 핵심 수치를 반복해서 쓰지 마세요.
- 추천 동네별 상세 설명, 한줄평, 핵심 수치는 neighborhoods와 visualization_data에만 담으세요.
- answer는 카드/시각화 영역으로 자연스럽게 이어지는 짧은 안내 문장만 작성하세요.
